...
) ENGINE=MyISAM AUTO_INCREMENT=1328 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
) ENGINE=MyISAM AUTO_INCREMENT=593557 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `repeat_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=3470530 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80 ROW_FORMAT=FIXED;
...
) ENGINE=MyISAM AUTO_INCREMENT=154673 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
