...
) ENGINE=MyISAM AUTO_INCREMENT=1878596425 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
) ENGINE=MyISAM AUTO_INCREMENT=1800023900 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
) ENGINE=MyISAM AUTO_INCREMENT=916121290 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 ROW_FORMAT=DYNAMIC;
...
) ENGINE=MyISAM AUTO_INCREMENT=1801664983 DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
...
CREATE TABLE `homology` (
  ...
  KEY `gene_tree_root_id` (`gene_tree_root_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1809222335 DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
...
) ENGINE=MyISAM AUTO_INCREMENT=123 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `seq_member` (
  ...
  KEY `stable_id` (`stable_id`)
) ENGINE=MyISAM AUTO_INCREMENT=953553351 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `sequence` (
  ...
  KEY `md5sum` (`md5sum`)
) ENGINE=MyISAM AUTO_INCREMENT=951992267 DEFAULT CHARSET=latin1 MAX_ROWS=10000000 AVG_ROW_LENGTH=19000 ROW_FORMAT=DYNAMIC;
...
) ENGINE=MyISAM AUTO_INCREMENT=36209 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
) ENGINE=MyISAM AUTO_INCREMENT=4015700123 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
