...
# info/species
{
  ...
  my $expected = {species => [ { division => 'Ensembl', name => 'homo_sapiens', common_name => 'human', display_name => 'Human', taxon_id => '9606', groups => ['core', 'variation'], aliases => [], release => $schema_version, assembly => 'GRCh37'} ]};
