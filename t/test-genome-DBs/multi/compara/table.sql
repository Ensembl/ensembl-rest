...
CREATE TABLE `genome_db` (
  ...
  KEY `taxon_id` (`taxon_id`)
) ENGINE=MyISAM AUTO_INCREMENT=144 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `genomic_align` (
  ...
  KEY `node_id` (`node_id`)
) ENGINE=MyISAM AUTO_INCREMENT=6410000023754 DEFAULT CHARSET=latin1 MAX_ROWS=1000000000 AVG_ROW_LENGTH=60 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `genomic_align_block` (
  ...
  KEY `method_link_species_set_id` (`method_link_species_set_id`)
) ENGINE=MyISAM AUTO_INCREMENT=6410000010711 DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
...
) ENGINE=MyISAM AUTO_INCREMENT=6410000023754 DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
...
) ENGINE=MyISAM AUTO_INCREMENT=166 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
) ENGINE=MyISAM AUTO_INCREMENT=50047 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `species_set` (
  ...
  KEY `genome_db_id` (`genome_db_id`)
) ENGINE=MyISAM AUTO_INCREMENT=35266 DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
...
) ENGINE=MyISAM AUTO_INCREMENT=35267 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
